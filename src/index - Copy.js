...
export async function run() {
  console.log("VERSION CHECK - index.js edited on new laptop - 2026-06-26 08:13");
  ...
  console.log("DEBUG first 10 issues Date Sent:");
issues.slice(0, 10).forEach(issue => {
  console.log(`${issue.key} Date Sent raw = ${issue.fields[DATE_SENT_FIELD]}`);
});
